...
const addDepartment = [
  {
    ...
    choices: ["Neonatal ICU", "Intermediate Care Nursery", "Newborn Well Baby"],
  },
];
...
const addEmployee = [
  ...
  },
  {
    ...
    choices: ["NICU Nurse", "ICN Nurse", "Well Baby Nursery", "Neonatal Float"],
  },
  {
    name: "manager",
    type: "list",
    message: "Please enter manager's role.",
    choices: [
